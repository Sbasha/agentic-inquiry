...
After several unsuccessful attempts on a reproduced defect, the optional
`systematic-debugging` skill can supplement diagnosis when installed. Its use
does not authorize another attempt or override the owning workflow's stop,
retry and review rules.
