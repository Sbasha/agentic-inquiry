...
4. Fill in the spec — including the **Testing Strategy** section. Push
   ...
   - **Body narrates history or the future.** Write the spec in the
     ...
     lives in the repository's decision records and revision history in
     Git, never in the spec or plan body; a `Drafting` plan is rewritten
     in place, and execution observations go to the verification ledger.
