...
Use `prototype` when the selected validation approach needs a disposable runnable logic experiment or a set of UI alternatives. A prototype result informs the assumption verdict; creating one alone does not establish that the bet survives.
