...
- For flowchart, state and class diagrams, the following palette is an optional example. Prefer the project's existing visual conventions; encode meaning through labels and shapes as well as color:
