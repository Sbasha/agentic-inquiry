...
Research claim trace: `TS-1`, `TS-2`, `TS-3`; see the [preserved source packet](../../provenance/foundations/tradeoffs-sensitivity-and-evolution.json). Its dates and confidence belong to the original source; current web verification is not established.
