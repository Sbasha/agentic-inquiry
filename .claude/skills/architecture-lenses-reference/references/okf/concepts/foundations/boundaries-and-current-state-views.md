...
Research claim trace: `BV-1`, `BV-2`, `BV-3`; see the [preserved source packet](../../provenance/foundations/boundaries-and-current-state-views.json). Its dates and confidence belong to the original source; current web verification is not established.
