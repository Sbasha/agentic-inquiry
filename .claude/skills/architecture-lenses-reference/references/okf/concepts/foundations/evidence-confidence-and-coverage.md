...
Research claim trace: `EC-1`, `EC-2`, `EC-3`; see the [preserved source packet](../../provenance/foundations/evidence-confidence-and-coverage.json). Its dates and confidence belong to the original source; current web verification is not established.
