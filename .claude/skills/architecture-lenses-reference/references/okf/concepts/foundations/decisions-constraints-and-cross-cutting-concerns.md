...
Research claim trace: `DC-1`, `DC-2`, `DC-3`; see the [preserved source packet](../../provenance/foundations/decisions-constraints-and-cross-cutting-concerns.json). Its dates and confidence belong to the original source; current web verification is not established.
