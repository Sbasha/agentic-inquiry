...
Research claim trace: `QA-1`, `QA-2`, `QA-3`; see the [preserved source packet](../../provenance/foundations/quality-attribute-scenarios.json). Its dates and confidence belong to the original source; current web verification is not established.
