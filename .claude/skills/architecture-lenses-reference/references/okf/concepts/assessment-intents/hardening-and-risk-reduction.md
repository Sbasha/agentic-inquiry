...
Research claim trace: `AI-H1`, `AI-H1b`; see the [preserved source packet](../../provenance/assessment-intents/hardening-and-risk-reduction.json). Its dates and confidence belong to the original source; current web verification is not established.
