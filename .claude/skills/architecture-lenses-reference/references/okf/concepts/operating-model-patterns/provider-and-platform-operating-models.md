...
Research claim trace: `PP-1`, `PP-1b`; see the [preserved source packet](../../provenance/operating-model-patterns/provider-and-platform-operating-models.json). Its dates and confidence belong to the original source; current web verification is not established.
