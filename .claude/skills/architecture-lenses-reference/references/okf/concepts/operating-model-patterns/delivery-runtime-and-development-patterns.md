...
Research claim trace: `DD-1`, `DD-1b`; see the [preserved source packet](../../provenance/operating-model-patterns/delivery-runtime-and-development-patterns.json). Its dates and confidence belong to the original source; current web verification is not established.
