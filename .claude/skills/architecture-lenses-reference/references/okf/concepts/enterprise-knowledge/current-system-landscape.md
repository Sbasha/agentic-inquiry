...
Research claim trace: `SL-1`, `SL-1b`; see the [preserved source packet](../../provenance/enterprise-knowledge/current-system-landscape.json). Its dates and confidence belong to the original source; current web verification is not established.
