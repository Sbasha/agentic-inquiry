...
Research claim trace: `OR-1`, `OR-1b`; see the [preserved source packet](../../provenance/enterprise-knowledge/operational-reality.json). Its dates and confidence belong to the original source; current web verification is not established.
