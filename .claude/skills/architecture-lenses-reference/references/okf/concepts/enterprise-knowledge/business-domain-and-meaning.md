...
Research claim trace: `BD-1`, `BD-1b`; see the [preserved source packet](../../provenance/enterprise-knowledge/business-domain-and-meaning.json). Its dates and confidence belong to the original source; current web verification is not established.
