...
Research claim trace: `SD-1`, `SD-1b`; see the [preserved source packet](../../provenance/enterprise-knowledge/source-detection-confidence-and-conflicts.json). Its dates and confidence belong to the original source; current web verification is not established.
