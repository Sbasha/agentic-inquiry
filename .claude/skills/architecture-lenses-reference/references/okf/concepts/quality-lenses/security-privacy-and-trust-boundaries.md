...
Research claim trace: `QL-S1`, `QL-S1b`; see the [preserved source packet](../../provenance/quality-lenses/security-privacy-and-trust-boundaries.json). Its dates and confidence belong to the original source; current web verification is not established.
