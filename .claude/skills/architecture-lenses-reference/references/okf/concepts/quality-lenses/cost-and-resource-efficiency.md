...
Research claim trace: `QL-C1`, `QL-C1b`; see the [preserved source packet](../../provenance/quality-lenses/cost-and-resource-efficiency.json). Its dates and confidence belong to the original source; current web verification is not established.
