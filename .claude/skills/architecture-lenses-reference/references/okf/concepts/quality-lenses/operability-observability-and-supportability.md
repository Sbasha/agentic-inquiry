...
Research claim trace: `QL-O1`, `QL-O1b`; see the [preserved source packet](../../provenance/quality-lenses/operability-observability-and-supportability.json). Its dates and confidence belong to the original source; current web verification is not established.
