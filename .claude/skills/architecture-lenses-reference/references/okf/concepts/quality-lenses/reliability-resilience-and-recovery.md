...
Research claim trace: `QL-R1`, `QL-R1b`; see the [preserved source packet](../../provenance/quality-lenses/reliability-resilience-and-recovery.json). Its dates and confidence belong to the original source; current web verification is not established.
