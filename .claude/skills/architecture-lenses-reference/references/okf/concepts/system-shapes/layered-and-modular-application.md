...
Research claim trace: `SS-M1`, `SS-M1b`; see the [preserved source packet](../../provenance/system-shapes/layered-and-modular-application.json). Its dates and confidence belong to the original source; current web verification is not established.
