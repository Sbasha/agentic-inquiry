...
Research claim trace: `SS-P1`, `SS-P1b`; see the [preserved source packet](../../provenance/system-shapes/monorepo-platform-and-infrastructure.json). Its dates and confidence belong to the original source; current web verification is not established.
