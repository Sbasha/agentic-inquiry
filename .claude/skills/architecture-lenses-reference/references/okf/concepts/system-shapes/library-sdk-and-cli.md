...
Research claim trace: `SS-L1`, `SS-L1b`; see the [preserved source packet](../../provenance/system-shapes/library-sdk-and-cli.json). Its dates and confidence belong to the original source; current web verification is not established.
