...
Research claim trace: `SS-C1`, `SS-C1b`; see the [preserved source packet](../../provenance/system-shapes/client-server.json). Its dates and confidence belong to the original source; current web verification is not established.
