...
Research claim trace: `SS-E1`, `SS-E1b`; see the [preserved source packet](../../provenance/system-shapes/event-driven-and-streaming.json). Its dates and confidence belong to the original source; current web verification is not established.
