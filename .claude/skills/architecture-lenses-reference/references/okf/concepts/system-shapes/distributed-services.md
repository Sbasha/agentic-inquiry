...
Research claim trace: `SS-D1`, `SS-D1b`; see the [preserved source packet](../../provenance/system-shapes/distributed-services.json). Its dates and confidence belong to the original source; current web verification is not established.
