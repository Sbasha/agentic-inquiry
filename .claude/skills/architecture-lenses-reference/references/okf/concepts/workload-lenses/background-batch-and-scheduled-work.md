...
Research claim trace: `WL-B1`, `WL-B1b`; see the [preserved source packet](../../provenance/workload-lenses/background-batch-and-scheduled-work.json). Its dates and confidence belong to the original source; current web verification is not established.
