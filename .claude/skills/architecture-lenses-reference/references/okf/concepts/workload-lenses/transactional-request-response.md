...
Research claim trace: `WL-T1`, `WL-T1b`; see the [preserved source packet](../../provenance/workload-lenses/transactional-request-response.json). Its dates and confidence belong to the original source; current web verification is not established.
