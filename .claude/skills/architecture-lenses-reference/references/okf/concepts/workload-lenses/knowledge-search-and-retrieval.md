...
Research claim trace: `WL-K1`, `WL-K1b`; see the [preserved source packet](../../provenance/workload-lenses/knowledge-search-and-retrieval.json). Its dates and confidence belong to the original source; current web verification is not established.
