...
Research claim trace: `WL-A2`, `WL-A2b`; see the [preserved source packet](../../../provenance/workload-lenses/genai-agentic/durable-run-state-and-recovery.json). Its dates and confidence belong to the original source; current web verification is not established.
