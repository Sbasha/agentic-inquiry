...
Research claim trace: `WL-A4`, `WL-A4b`; see the [preserved source packet](../../../provenance/workload-lenses/genai-agentic/knowledge-provenance-and-isolation.json). Its dates and confidence belong to the original source; current web verification is not established.
