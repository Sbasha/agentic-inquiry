...
Review of `CLAUDE.md` or Claude scoped repository rules belongs to `authoring-claude-md` when installed. This workflow reviews reusable skill packages, including their triggers, resources and evaluations.
