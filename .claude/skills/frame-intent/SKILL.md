...
Use `grill-me` for an explicitly requested interview that stress-tests the user's thinking without creating or enacting an intent. This skill owns the durable intent when that is the requested outcome.
