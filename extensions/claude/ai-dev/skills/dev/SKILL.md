...
```bash
# Dev mode ON
export INQUIRY_CONFIG=.agentic-inquiry/dev/config.yaml
export INQUIRY_PROJECT_ID=ai-dev

# Dev mode OFF
unset INQUIRY_CONFIG  # uses default
export INQUIRY_PROJECT_ID=default
```
