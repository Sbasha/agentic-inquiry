---
name: quality
description: Agentic Inquiry quality standards - checklists, fragile areas, fix-break prevention, and ai tool guidance. Auto-loads when assessing code quality.
user-invocable: false
---

# ai Quality Standards

Quality checklists and risk awareness for Agentic Inquiry development.
...
2. **Test with fresh database**
   - Delete `.agentic-inquiry/` and re-index
