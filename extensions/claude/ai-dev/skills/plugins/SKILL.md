---
name: plugins
description: Agentic Inquiry CLI extensions and plugin integrations - Gemini, OpenCode, Codex, Copilot. Auto-loads when working with plugin extensions.
...
- Use the repo-local `.github/` mirror, which already points at the same
  `.claude/` skills and agents.
- `.github/copilot-instructions.md` resolves to `AGENTS.md`.
- `.github/skills/` and `.github/agents/` resolve to the canonical Claude tree.
