...
description: Agentic Inquiry coding standards - parser constraints, logging, types, security, and async patterns. Auto-loads when writing or reviewing ai code.
user-invocable: false
---

# ai Coding Guidelines

Standards for contributing to Agentic Inquiry.

## When to Use

- Writing new code for ai
- Reviewing PRs
