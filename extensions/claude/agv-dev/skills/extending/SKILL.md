---
name: extending
description: How to extend Agent-Vault - add parsers, tools, config options, entity types, and more. Auto-loads when adding new agv capabilities.
...
```python
from agent_vault.parsers.base import BaseParser, register_parser
...
```python
from agent_vault.mcp.tools.base import BaseTool
