---
name: commit
description: Agent-Vault commit requirements - pre-commit checks, documentation, session tracking. Auto-loads when committing agv changes.
disable-model-invocation: true
---

# agv Commit Requirements

Standards for committing changes to Agent-Vault.
...
uv run mypy agent_vault/              # Type checking
