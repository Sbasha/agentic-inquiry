---
name: testing
description: Agent-Vault testing guidelines - commands, fixtures, anti-patterns, and condition polling. Auto-loads when writing or running tests.
user-invocable: false
---

# agv Testing Guidelines

Standards for testing Agent-Vault code.
...
def mock_embedding_registry():
    with patch('agent_vault.embeddings.registry') as mock:
