"""agv Daemon API - aiohttp route handlers.
...
logger = logging.getLogger("agv.daemon.api")
        ...
        return web.json_response(
            {
                ...
                "prompt": "[agv] WARNING: Pre-compact snapshot failed. REQUIRED: Manually store key decisions and discoveries NOW before context compresses.",
            }
        )
        ...
        return web.json_response(
            {
                ...
                "prompt": "[agv] WARNING: Session summary failed. REQUIRED: Store any decisions, patterns, or gotchas before session ends.",
            }
        )
