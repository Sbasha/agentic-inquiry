#!/usr/bin/env python3
"""Shared daemon communication helper for agv hook scripts.

All hook scripts use this to communicate with the agv daemon over Unix socket.
...
def get_socket_path(workspace: str | None = None) -> str:
    ...
    """
    socket_dir = os.environ.get("agv_HOME", os.path.expanduser("~/.agv"))
    if workspace:
