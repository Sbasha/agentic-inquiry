...
Usage:
    ai entity <name> [--project PROJECT] [--json]
...
def main(args: Optional[list[str]] = None) -> int:
    ...
    if not args:
        print("Usage: ai entity <name> [--project PROJECT] [--json] [--verbose]")
        print("       ai entity deps <name> [--project PROJECT] [--json]")
        print("       ai entity refs <name> [--project PROJECT] [--json]")
        return 1
