...
from agentic_inquiry.search.rerankers.linear import LinearCombinationReranker

# Optional ML-based rerankers (may not be available)
try:
    from agentic_inquiry.search.rerankers.cross_encoder import CrossEncoderReranker
except ImportError:
    CrossEncoderReranker = None  # type: ignore[misc, assignment]

try:
    from agentic_inquiry.search.rerankers.colbert import ColBERTReranker
except ImportError:
