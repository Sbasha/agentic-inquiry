...
async def create_session(
    services: dict, project_id: str, description: Optional[str] = None
) -> dict:
...
async def get_session(
    services: dict, session_id: str, include_history: bool = True
) -> dict:
    ...
    try:
        session = await session_manager.get_session(
            session_id=session_id, include_history=include_history
        )
        ...
        return {"error": str(e), "suggestion": "Check session_id is valid"}
...
async def list_sessions(
    ...
    try:
        ...
        return {"error": str(e), "suggestion": "Check database is accessible"}


async def resume_session(services: dict, session_id: str) -> dict:
...
__all__ = ["create_session", "get_session", "list_sessions", "resume_session"]
