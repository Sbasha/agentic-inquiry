...
def get_document_chunks_schema(vector_dims: int = 128) -> Optional[Any]:
    ...
    return pa.schema(
        [
            ...
            pa.field(
                "source_modified_at", pa.string(), nullable=False
            ),  # ISO format datetime
            pa.field(
                "metadata",
                pa.struct(
...
def get_graph_entities_schema(vector_dims: int = 128) -> Optional[Any]:
    ...
    return pa.schema(
        [
            ...
            pa.field(
                "domain", pa.string(), nullable=False
            ),  # Entity domain (code, ontology, taxonomy, documentation)
            pa.field("file_path", pa.string(), nullable=False),
            pa.field("doc_id", pa.string(), nullable=False),
            pa.field("project_id", pa.string(), nullable=False),
            pa.field("vector", pa.list_(pa.float32(), vector_dims), nullable=False),
...
def get_memory_episodic_schema(
    ...
    return pa.schema(
        [
            ...
            pa.field(
                "vector", pa.list_(pa.float32(), content_vector_dims), nullable=False
            ),
            pa.field(
                "summary_vector",
                pa.list_(pa.float32(), summary_vector_dims),
                nullable=False,
            ),
