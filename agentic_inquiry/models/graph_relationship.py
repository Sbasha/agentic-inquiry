...
class CodeRelationshipMetadata:
    ...
    line: Optional[int] = None  # Line number of the call (alias for line_number from parser)
...
) -> Optional[Union[CodeRelationshipMetadata, DocumentationRelationshipMetadata, 
                    TemporalRelationshipMetadata, TestRelationshipMetadata, 
                    SemanticRelationshipMetadata, Dict[str, Any]]]:
...
class GraphRelationship:
    ...
    def __post_init__(self) -> None:
        if not all(isinstance(value, str) and value for value in (self.id, self.source_id, self.target_id, self.type, self.project_id)):
            raise ValueError("GraphRelationship id, source_id, target_id, type and project_id must be non-empty strings")
    ...
    def get_typed_metadata(self) -> Optional[Union[CodeRelationshipMetadata, 
    ...
    def set_typed_metadata(self, metadata: Union[CodeRelationshipMetadata,
                                                   DocumentationRelationshipMetadata,
                                                   TemporalRelationshipMetadata,
                                                   TestRelationshipMetadata,
                                                   SemanticRelationshipMetadata,
