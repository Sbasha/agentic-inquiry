...
StorageError from agentic_inquiry.exceptions. These exceptions provide
more granular error handling for storage operations.

Exception Hierarchy:
    StorageError (from agentic_inquiry.exceptions)
    ├── ConnectionError
    ├── QueryError
    ├── TransactionError
...
Usage:
    from agentic_inquiry.storage.exceptions import ConnectionError, QueryError
