...
from agentic_inquiry.storage.protocols.events import (
    EventStorageProtocol,
    has_event_storage,
)
from agentic_inquiry.storage.protocols.lifecycle import (
    BackendLifecycle,
    has_lifecycle_support,
)
from agentic_inquiry.storage.protocols.file_tracker import (
    FileTrackerProtocol,
    has_file_tracker,
)
from agentic_inquiry.storage.protocols.graph import (
    GraphStorageProtocol,
    has_graph_storage,
)
from agentic_inquiry.storage.protocols.indexing import (
