...
Example:
    ...
    ... )
    >>> from agentic_inquiry.parsers.recognizers.java_spring import (
...
from agentic_inquiry.parsers.recognizers.base import (
    Recognizer,
    apply_recognizers,
...
def _register_builtin_recognizers() -> None:
    ...
    if "apex_salesforce" not in registered:
        from agentic_inquiry.parsers.recognizers.apex_salesforce import (
    ...
    if "lwc_salesforce" not in registered:
        from agentic_inquiry.parsers.recognizers.lwc_salesforce import (
