...
Example:
    >>> from agentic_inquiry.cache import get_cache
    >>> cache = get_cache()
...
# eagerly at import time would make ``import agentic_inquiry.cache`` unexpectedly
# expensive and break in environments where config isn't available.
from agentic_inquiry.cache.document_cache import DocumentCache  # noqa: E402
