...
class TestCacheInvalidation:
    ...
    @pytest.mark.asyncio
    async def test_invalidation_on_file_modification(self, cache, sample_document, tmp_path):
...
class TestDiskPersistence:
    ...
    @pytest.mark.asyncio
    async def test_save_and_load_from_disk(self, disk_cache, disk_cache_config, sample_document, tmp_path):
