...
class TestMaintenanceConfigEnvOverrides:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("AGV_MAINTENANCE_TRIGGER", "indexing.completed", {'maintenance': {'trigger': 'project.closed'}}, ("maintenance", "trigger"), "indexing.completed"),
            ("AGV_MAINTENANCE_RETENTION_MINUTES", "120", {'maintenance': {'cleanup_retention_minutes': 60}}, ("maintenance", "cleanup_retention_minutes"), 120),
            ("AGV_MAINTENANCE_ENABLED", "false", {'maintenance': {'enabled': True}}, ("maintenance", "enabled"), False),
        ],
    )
    ...
    def test_multiple_maintenance_overrides(self, monkeypatch):
        ...
        monkeypatch.setenv("AGV_MAINTENANCE_TRIGGER", "disabled")
        monkeypatch.setenv("AGV_MAINTENANCE_RETENTION_MINUTES", "30")
        monkeypatch.setenv("AGV_MAINTENANCE_ENABLED", "false")
    ...
    def test_invalid_maintenance_trigger_raises_error(self, monkeypatch):
        ...
        monkeypatch.setenv("AGV_MAINTENANCE_TRIGGER", "invalid_trigger")
    ...
    def test_invalid_retention_minutes(self, monkeypatch, env_value, expected_substrings):
        ...
        monkeypatch.setenv("AGV_MAINTENANCE_RETENTION_MINUTES", env_value)
...
class TestMCPQueryConfigEnvOverrides:
    ...
    @pytest.mark.parametrize(
        ("env_var", "env_value", "config_data", "path", "expected"),
        [
            ("AGV_TRAVERSAL_LIMIT", "1000", {'mcp': {'query': {'traversal_limit': 500}}}, ("mcp", "query", "traversal_limit"), 1000),
            ("AGV_BATCH_SIZE", "250", {'mcp': {'query': {'batch_size': 100}}}, ("mcp", "query", "batch_size"), 250),
        ],
    )
    ...
    def test_multiple_query_overrides(self, monkeypatch):
        ...
        monkeypatch.setenv("AGV_TRAVERSAL_LIMIT", "1500")
        monkeypatch.setenv("AGV_BATCH_SIZE", "200")
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("AGV_TRAVERSAL_LIMIT", "99", ["traversal_limit must be between 100 and 2000", "got 99"]),
            ("AGV_TRAVERSAL_LIMIT", "2001", ["traversal_limit must be between 100 and 2000", "got 2001"]),
            ("AGV_BATCH_SIZE", "9", ["batch_size must be between 10 and 500", "got 9"]),
            ("AGV_BATCH_SIZE", "501", ["batch_size must be between 10 and 500", "got 501"]),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("AGV_TRAVERSAL_LIMIT", "100", ("mcp", "query", "traversal_limit"), 100),
            ("AGV_TRAVERSAL_LIMIT", "2000", ("mcp", "query", "traversal_limit"), 2000),
            ("AGV_BATCH_SIZE", "10", ("mcp", "query", "batch_size"), 10),
            ("AGV_BATCH_SIZE", "500", ("mcp", "query", "batch_size"), 500),
        ],
    )
...
class TestConfigIntegration:
    ...
    def test_all_new_env_vars_together(self, monkeypatch):
        ...
        monkeypatch.setenv("AGV_MAINTENANCE_TRIGGER", "indexing.completed")
        monkeypatch.setenv("AGV_MAINTENANCE_RETENTION_MINUTES", "180")
        monkeypatch.setenv("AGV_MAINTENANCE_ENABLED", "false")
        monkeypatch.setenv("AGV_TRAVERSAL_LIMIT", "1200")
        monkeypatch.setenv("AGV_BATCH_SIZE", "300")
...
"""
        ...
        monkeypatch.setenv("AGV_MAINTENANCE_TRIGGER", "disabled")
        monkeypatch.setenv("AGV_MAINTENANCE_RETENTION_MINUTES", "720")
        monkeypatch.setenv("AGV_TRAVERSAL_LIMIT", "1800")
        monkeypatch.setenv("AGV_BATCH_SIZE", "400")
    ...
    def test_partial_env_override(self, monkeypatch):
        ...
        monkeypatch.setenv("AGV_MAINTENANCE_RETENTION_MINUTES", "90")
        monkeypatch.setenv("AGV_BATCH_SIZE", "150")
    ...
    def test_type_conversion_for_env_vars(self, monkeypatch):
        ...
        monkeypatch.setenv("AGV_MAINTENANCE_RETENTION_MINUTES", "240")
        monkeypatch.setenv("AGV_TRAVERSAL_LIMIT", "1500")
        monkeypatch.setenv("AGV_BATCH_SIZE", "250")
    ...
    def test_logging_of_applied_overrides(self, monkeypatch, caplog):
        ...
        monkeypatch.setenv("AGV_MAINTENANCE_RETENTION_MINUTES", "120")
        monkeypatch.setenv("AGV_TRAVERSAL_LIMIT", "1000")
        ...
        assert any("AGV_MAINTENANCE_RETENTION_MINUTES" in msg for msg in debug_messages)
        assert any("AGV_TRAVERSAL_LIMIT" in msg for msg in debug_messages)
...
class TestAcceptanceCriteria:
    ...
    def test_ac_4_3_cleanup_retention_minutes_respected(self, monkeypatch):
        ...
        monkeypatch.setenv("AGV_MAINTENANCE_RETENTION_MINUTES", "360")
...
class TestPackagedConfigResolver:
    ...
    def test_packaged_copy_wins_over_source_tree(self, tmp_path, monkeypatch) -> None:
        """An installed wheel prefers agent_vault/config_defaults/."""
        ...
        monkeypatch.setattr(
            "agent_vault.config._resource_files",
    ...
    def test_find_config_file_falls_back_to_package_default(
        ...
        monkeypatch.delenv("agv_CONFIG", raising=False)
        monkeypatch.chdir(tmp_path)
        # Isolate from a leftover ~/.agv/config.yaml on the developer machine.
