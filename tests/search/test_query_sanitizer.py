...
class TestQuerySanitizer:
    ...
    def test_sanitize_mixed_special_chars(self):
        ...
        # Complex query
        assert sanitizer.sanitize("How does file*.py work?") == "How does file\\*\\.py work\\?"
    ...
    def test_preserve_wildcards_mode(self):
        ...
        assert sanitizer.preserve_wildcards_mode("test[123]*.py") == "test\\[123\\]*\\.py"
    ...
    def test_real_world_queries(self):
        ...
        # Code snippet
        assert sanitizer.sanitize("function test() { return true; }") == \
    ...
    def test_whitespace_handling(self):
        ...
        assert sanitizer.sanitize("query    with    spaces") == "query    with    spaces"
