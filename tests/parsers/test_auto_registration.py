...
def test_parsers_auto_registered():
    ...
    assert "fallback_text" in parsers, "Fallback text parser should always be registered (no dependencies)"
...
def test_get_parser_instance_retrieves_protocol():
    ...
    assert hasattr(parser_instance, "parse"), \
        "Parser instance should have parse method"
...
def test_registered_parser_names():
    ...
    assert "fallback_text" in parsers, "Fallback text parser should be registered as 'fallback_text'"
