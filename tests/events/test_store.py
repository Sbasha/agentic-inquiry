...
class TestDatabaseInitialization:
    ...
    async def test_lazy_initialization(self, tmp_path: Path):
        ...
        store = EventStore(db_path=db_path, project_id="test_project")
...
class TestEventQueryOperations:
    ...
    async def test_get_operation_events_with_project_id_filter(self, tmp_path: Path):
        ...
        store1 = await EventStore.from_config(db_path=db_path, project_id="project1")

        # Create store for project2
        store2 = await EventStore.from_config(db_path=db_path, project_id="project2")
