...
class TestCreateSessionValidation:
    ...
    @pytest.mark.asyncio
    async def test_create_session_with_invalid_project_id_characters(
        self, mcp_services
    ):
    ...
    @pytest.mark.asyncio
    async def test_create_session_error_message_includes_get_server_info(
        self, mcp_services
    ):
    ...
    async def test_create_session_successful_with_valid_project_id(self, mcp_services):
        ...
        result = await create_session(
            mcp_services, project_id="my-project", description="Test session"
        )
