...
@pytest.mark.asyncio
async def test_add_knowledge_python_file(mcp_services, patch_indexing_pipeline, tmp_path, monkeypatch):
...
@pytest.mark.asyncio
async def test_add_knowledge_typescript_file(mcp_services, patch_indexing_pipeline, tmp_path, monkeypatch):
...
@pytest.mark.asyncio
async def test_add_knowledge_markdown_file(mcp_services, patch_indexing_pipeline, tmp_path, monkeypatch):
...
@pytest.mark.asyncio
async def test_add_knowledge_directory_mixed_files(mcp_services, patch_indexing_pipeline, tmp_path, monkeypatch):
...
@pytest.mark.asyncio
async def test_add_knowledge_error_handling_invalid_path(mcp_services, patch_indexing_pipeline, tmp_path, monkeypatch):
    ...
    assert any(keyword in error_msg.lower() for keyword in ["not found", "does not exist", "file", "no such"]), \
        f"Expected error message about missing file, got: {error_msg}"


@pytest.mark.asyncio
async def test_add_knowledge_error_handling_unsupported_file(mcp_services, patch_indexing_pipeline, tmp_path, monkeypatch):
...
@pytest.mark.asyncio
async def test_add_knowledge_directory_continues_on_error(mcp_services, patch_indexing_pipeline, tmp_path, monkeypatch):
...
@pytest.mark.asyncio
async def test_add_knowledge_directory_with_gitignore(mcp_services, patch_indexing_pipeline, tmp_path, monkeypatch):
