...
class TestProgressEvent:
    ...
    def test_progress_event_creation(self):
        ...
        event = ProgressEvent(
            event_type="progress", current=5, total=10, file="test.py", percent=50
        )
...
class TestProgressHandler:
    ...
    def test_format_progress(self):
        ...
        assert (
            "Operation complete" in messages[1] or "Completed 10 items" in messages[1]
        )
    ...
    def test_multiple_progress_events(self):
        ...
        for i in range(1, 11):
            handler.on_progress(current=i, total=10, file=f"test{i}.py", percent=i * 10)
