...
if TYPE_CHECKING:
    from agent_vault.database.filters import Filter, FilterInput

from agent_vault.database.filters.dict_translator import format_in_clause
...
from agent_vault.config import Config  # noqa: E402 - after optional dependency handling
from agent_vault.constants import CURRENT_PROJECT_ID  # noqa: E402
from agent_vault.database.connection import ConnectionManager  # noqa: E402
from agent_vault.database.lancedb_schemas import (  # noqa: E402
    FORBIDDEN_FIELD_ALIASES,
    REQUIRED_FIELDS,
    TABLE_CONFIGS,
)
from agent_vault.database.tables import TableManager  # noqa: E402
from agent_vault.exceptions import StorageError  # noqa: E402
from agent_vault.storage.similarity import DEFAULT_SIMILARITY_METRIC  # noqa: E402
...
class LanceDBManager:
        ...
        with self._metrics.track_latency(f"db.count_records.{table_name}"):
            try:
                ...
                if filters or project_id:
                    ...
                    from agent_vault.database.filters import Filter, and_, eq
    ...
    def _filters_to_expression(self, filters: "Optional[FilterInput]") -> Optional[str]:
        ...
        WHERE clause).
        """
        from agent_vault.database.filters import LanceDBFilterAdapter
