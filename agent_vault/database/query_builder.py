...
from agent_vault.database.filters import Filter, translate_filter, translate_dict_filters
...
class LanceDBQueryBuilder:
    ...
    def _add_project_filter(
        ...
        """
        from agent_vault.database.filters import eq, and_
    ...
    def _filters_to_expression(
        ...
        Delegates to agent_vault.database.filters for consolidated filter translation.
