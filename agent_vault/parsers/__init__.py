...
The :mod:`agent_vault.parsers` package exposes a small set of helpers that
...
Example usage::
    ...
    from agent_vault.parsers import ParserRegistry, register_parser, parse_with_registry
