...
dependency injection. It integrates with existing Agent-Vault services and
...
from agent_vault.memory.adapters.inmemory_adapter import InMemoryMemoryAdapter
...
async def create_mcp_services(config: Config, project_id: str) -> Dict[str, Any]:
    ...
    This factory function creates both core Agent-Vault services and
    ...
    try:
        # Create core services (existing Agent-Vault components)
        ...
        from agent_vault.mcp.utils.performance import PerformanceMonitor
