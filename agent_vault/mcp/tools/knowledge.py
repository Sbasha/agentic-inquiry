        ...
        async def _do_indexing(
            ...
            for file_path in files:
                try:
                    ...
                    from agent_vault.exceptions import ParsingError, SchemaValidationError
...
async def add_knowledge(
    ...
    Example:
        ...
        ...     services, "sess_123",
        ...     content_type="file",
        ...     source="agent_vault/search/service.py"
        ... )
    ...
    try:
        ...
        from agent_vault.exceptions import ValidationError as AGVValidationError
