...
async def get_server_info(
    ...
    Example:
        ...
        [{'project_id': 'agent-vault', 'chunks': 1234, ...}, ...]
    ...
    try:
        ...
        server_metadata = {
            "name": server_config.get("server_name", "Agent-Vault MCP Server"),
        ...
        # Get default project
        default_project_id = server_config.get("default_project_id", "agent-vault")
        default_project = {
