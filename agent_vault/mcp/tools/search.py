...
import numpy as np
from agent_vault.database.filter_helpers import (
    combine_filters,
    by_type,
    id_in_list,
)
from agent_vault.models.graph_entity import GraphEntity
from agent_vault.utils.metacognition import ClarificationBuilder
...
async def search_knowledge(
    ...
    try:
        ...
        from agent_vault.search.strategy import determine_search_strategy
