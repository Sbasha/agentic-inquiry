...
the Agent-Vault MCP server.

Usage:
    # Start with default configuration
    python -m agent_vault.mcp.cli --project-id my_project
    
    # With custom configuration
    python -m agent_vault.mcp.cli --config custom.yaml --project-id my_project
    
    # Enable direct access tools
    python -m agent_vault.mcp.cli --project-id my_project --enable-direct-tools
    
    # Specify host and port
    python -m agent_vault.mcp.cli --project-id my_project --host 0.0.0.0 --port 9000
"""
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Agent-Vault MCP Server - AI-powered code and knowledge search",
...
async def async_main():
    ...
    logger.info("Starting Agent-Vault MCP Server")
