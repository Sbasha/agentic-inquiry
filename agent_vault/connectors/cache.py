...
from agent_vault.connectors.lru_cache import CacheStats, FileCacheTracker
...
class ContentMaterializer:
    ...
    Example:
        >>> materializer = ContentMaterializer(cache_root="/tmp/agv_cache")
    ...
    def __init__(
        ...
        if cache_root is None:
            cache_root = os.path.join(tempfile.gettempdir(), "agent-vault_cache")
