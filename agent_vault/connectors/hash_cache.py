...
from agent_vault.connectors.lru_cache import CacheStats, LRUCache
from agent_vault.connectors.protocols import HashTrackerProtocol
...
class BoundedHashCache:
    ...
    Example:
        >>> from agent_vault.connectors import InMemoryFileTracker
