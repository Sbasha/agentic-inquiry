"""HTTP client for agv server REST API.
...
from agent_vault.server.lifecycle import ENV_DEFAULT, ensure_server, get_server_url

logger = logging.getLogger("agv.server.client")


class agvClient:
    """HTTP client for the agv REST API.
