...
from agent_vault.embeddings.registry import EmbeddingRegistry, embedding_registry
...
from agent_vault.models import DocumentChunk, GraphRelationship
...
from agent_vault.watching import WatcherProtocol
...
from agent_vault.indexing.priority import (
    prioritize_files,
    get_fast_path_files,
)
...
from agent_vault.mcp.utils.validation import validate_path
...
def _graph_write_indexing_error(exc: BaseException) -> Any:
    ...
    return IndexingError(
        ...
        suggestion=(
            ...
            "Re-run agv index after the graph write succeeds."
        ),
    )
...
class IndexingPipeline:
    ...
    async def _discover_files(
        ...
        """
        from agent_vault.utils.ignore_handler import get_ignore_handler

        # If connector is provided, use it for discovery
        if self.connector is not None:
            from agent_vault.connectors.protocols import ChangeDetectionCapability
    ...
    async def _index_sync(
        ...
        """
        from agent_vault.indexing.models import IndexingResult, IndexingError
