"""Composable storage layer for Agent-Vault.
...
Usage:
    from agent_vault.storage import StorageFacade
...
For protocol-aware code:
    from agent_vault.storage.protocols import (
...
from agent_vault.storage.exceptions import (
    ConnectionError,
