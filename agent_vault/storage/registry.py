...
from agent_vault.storage.config import BackendType, StorageRole
...
PROVIDER_REGISTRY: Dict[str, Dict[StorageRole, Tuple[str, str]]] = {
    ...
    "postgresql": {
        ...
        "file_tracker": (
            "agent_vault.storage.providers.postgresql",
            "PostgresFileTrackerProvider",
        ),
        "onboard_metadata": (
            "agent_vault.onboard.providers.postgresql",
    ...
    "sqlite": {
        "events": ("agent_vault.storage.providers.sqlite", "SQLiteEventProvider"),
        "file_tracker": (
            "agent_vault.storage.providers.sqlite",
            "SQLiteFileTrackerProvider",
        ),
        "onboard_metadata": (
            "agent_vault.onboard.providers.sqlite",
            "SQLiteOnboardMetadataProvider",
        ),
    },
    "spanner": {
        "graph": ("agent_vault.storage.providers.spanner", "SpannerGraphProvider"),
    },
    "memory": {
...
def get_registry_info() -> Dict[str, Dict[str, str]]:
    ...
    Example:
        ...
        "agent_vault.storage.providers.sqlite.SQLiteEventProvider"
    """
