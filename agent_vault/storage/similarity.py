...
Agent-Vault exposes a single canonical vocabulary for similarity metrics
...
Example:
    >>> from agent_vault.storage.similarity import lancedb_metric
...
"""Canonical set of similarity metric names accepted by Agent-Vault config."""
