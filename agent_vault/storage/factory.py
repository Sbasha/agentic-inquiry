...
from agent_vault.storage.exceptions import ProviderNotFoundError
...
_PROVIDER_REGISTRY: Dict[str, tuple[str, str]] = {
    "lancedb": (
        "agent_vault.storage.providers.lancedb",
        "LanceDBProvider",
    ),
    "memory": (
...
def register_provider(
    ...
    Args:
        ...
        module_path: Full module path (e.g., "agent_vault.storage.providers.lancedb")
