"""Interactive setup wizard for Agent-Vault.
...
Usage:
    agv setup                  # Interactive mode - prompts for backend type
    agv setup local [name]     # LanceDB (development)
    agv setup postgres [name]  # PostgreSQL (direct connection)
    agv setup gcp [name]       # CloudSQL (GCP managed)
    agv setup --dev            # Create test environment

Environment Naming:
    - Default: 'agv' (production)
    - With --dev: 'agv-test' or 'agv-test-<name>'
...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Configure Agent-Vault storage backend",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  agv setup                    Interactive mode
  agv setup local              LanceDB (development)
  agv setup alloydb            AlloyDB (GCP, server-side embeddings)
  agv setup gcp                CloudSQL (GCP, standard PostgreSQL)
  agv setup postgres           PostgreSQL (direct connection)
  agv setup aws                RDS (AWS managed)
""",
    )
    ...
    parser.add_argument(
        "name",
        nargs="?",
        help="Environment name (default: 'agv' or 'agv-test' with --dev)",
    )
...
def run_interactive_setup(
    ...
    """
    print("========================================")
    print("  Agent-Vault Environment Setup")
    print("========================================")
